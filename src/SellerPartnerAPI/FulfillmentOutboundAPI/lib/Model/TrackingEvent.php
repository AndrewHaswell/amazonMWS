...
class TrackingEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'event_date' => '\Swagger\Client\Model\Timestamp',
        'event_address' => '\Swagger\Client\Model\TrackingAddress',
        'event_code' => '\Swagger\Client\Model\EventCode',
     ...
     * Sets event_date
     *
     * @param \Swagger\Client\Model\Timestamp $event_date The date and time that the delivery event took place, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     * Sets event_address
     *
     * @param \Swagger\Client\Model\TrackingAddress $event_address The city where the delivery event took place.
     *
     * @return $this
     */
     ...
     * Gets event_code
     *
     * @return \Swagger\Client\Model\EventCode
     */
     ...
     * Sets event_code
     *
     * @param \Swagger\Client\Model\EventCode $event_code The event code for the delivery event.
     *
     * @return $this
     */
