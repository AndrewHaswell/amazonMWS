...
class GetFeatureInventoryResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'feature_name' => 'string',
        'next_token' => 'string',
        'feature_skus' => '\Swagger\Client\Model\FeatureSku[]'
    ];
     ...
     * Sets feature_skus
     *
     * @param \Swagger\Client\Model\FeatureSku[] $feature_skus An array of SKUs eligible for this feature and the quantity available.
     *
     * @return $this
     */
