...
class CODSettings implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'cod_charge' => '\Swagger\Client\Model\Money',
        'cod_charge_tax' => '\Swagger\Client\Model\Money',
        'shipping_charge' => '\Swagger\Client\Model\Money',
        'shipping_charge_tax' => '\Swagger\Client\Model\Money'
    ];
     ...
     * Sets cod_charge
     *
     * @param \Swagger\Client\Model\Money $cod_charge The amount of the COD charge to be collected from the recipient for a COD order.
     *
     * @return $this
     */
     ...
     * Sets cod_charge_tax
     *
     * @param \Swagger\Client\Model\Money $cod_charge_tax The amount of the tax on the COD charge to be collected from the recipient for a COD order.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Money $shipping_charge The amount of the tax on the COD charge to be collected from the recipient for a COD order.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Money $shipping_charge_tax The amount of the tax on the shipping charge to be collected from the recipient for a COD order.
     *
     * @return $this
     */
