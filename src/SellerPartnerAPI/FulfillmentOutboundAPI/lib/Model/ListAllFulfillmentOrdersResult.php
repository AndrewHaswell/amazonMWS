...
class ListAllFulfillmentOrdersResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'next_token' => 'string',
        'fulfillment_orders' => '\Swagger\Client\Model\FulfillmentOrder[]'
    ];
     ...
     *
     * @param \Swagger\Client\Model\FulfillmentOrder[] $fulfillment_orders An array of fulfillment order information.
     *
     * @return $this
     */
