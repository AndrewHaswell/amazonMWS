...
class FulfillmentOrderItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'cancelled_quantity' => '\Swagger\Client\Model\Quantity',
        'unfulfillable_quantity' => '\Swagger\Client\Model\Quantity',
        'estimated_ship_date' => '\Swagger\Client\Model\Timestamp',
        'estimated_arrival_date' => '\Swagger\Client\Model\Timestamp',
        'per_unit_price' => '\Swagger\Client\Model\Money',
        'per_unit_tax' => '\Swagger\Client\Model\Money',
        'per_unit_declared_value' => '\Swagger\Client\Model\Money'
    ];
     ...
     *
     * @param \Swagger\Client\Model\Quantity $cancelled_quantity The item quantity that was cancelled by the seller.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Quantity $unfulfillable_quantity The item quantity that is unfulfillable.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $estimated_ship_date The estimated date and time that the item quantity is scheduled to ship from the fulfillment center. Note that this value can change over time. If the shipment that contains the item quantity has been cancelled, estimatedShipDate is not returned.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $estimated_arrival_date The estimated arrival date and time of the item quantity. Note that this value can change over time. If the shipment that contains the item quantity has been cancelled, estimatedArrivalDate is not returned.
     *
     * @return $this
     */
     ...
     * Sets per_unit_price
     *
     * @param \Swagger\Client\Model\Money $per_unit_price The amount to be collected from the recipient for this item in a COD (Cash On Delivery) order.
     *
     * @return $this
     */
     ...
     * Sets per_unit_tax
     *
     * @param \Swagger\Client\Model\Money $per_unit_tax The tax on the amount to be collected from the recipient for this item in a COD (Cash On Delivery) order.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Money $per_unit_declared_value The monetary value assigned by the seller to this item.
     *
     * @return $this
     */
