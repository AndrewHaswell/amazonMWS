...
class ReturnAuthorization implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'return_to_address' => '\Swagger\Client\Model\Address',
     ...
     *
     * @param \Swagger\Client\Model\Address $return_to_address The address of the Amazon fulfillment center that the return items should be sent to.
     *
     * @return $this
     */
