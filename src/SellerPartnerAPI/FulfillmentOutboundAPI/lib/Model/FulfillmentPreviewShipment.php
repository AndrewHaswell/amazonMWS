...
class FulfillmentPreviewShipment implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'earliest_ship_date' => '\Swagger\Client\Model\Timestamp',
        'latest_ship_date' => '\Swagger\Client\Model\Timestamp',
        'earliest_arrival_date' => '\Swagger\Client\Model\Timestamp',
        'latest_arrival_date' => '\Swagger\Client\Model\Timestamp',
        'shipping_notes' => 'string[]',
        'fulfillment_preview_items' => '\Swagger\Client\Model\FulfillmentPreviewItemList'
    ];
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $earliest_ship_date The earliest date that the shipment is expected to be sent from the fulfillment center, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $latest_ship_date The latest date that the shipment is expected to be sent from the fulfillment center, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $earliest_arrival_date The earliest date that the shipment is expected to arrive at its destination.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $latest_arrival_date The latest date that the shipment is expected to arrive at its destination, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\FulfillmentPreviewItemList
     */
     ...
     *
     * @param \Swagger\Client\Model\FulfillmentPreviewItemList $fulfillment_preview_items Information about the items in the shipment.
     *
     * @return $this
     */
