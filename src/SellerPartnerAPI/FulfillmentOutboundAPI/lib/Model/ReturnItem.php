...
class ReturnItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'status' => '\Swagger\Client\Model\FulfillmentReturnItemStatus',
        'status_changed_date' => '\Swagger\Client\Model\Timestamp',
        'return_authorization_id' => 'string',
        'return_received_condition' => '\Swagger\Client\Model\ReturnItemDisposition',
     ...
     * Gets status
     *
     * @return \Swagger\Client\Model\FulfillmentReturnItemStatus
     */
     ...
     * Sets status
     *
     * @param \Swagger\Client\Model\FulfillmentReturnItemStatus $status Indicates if the return item has been processed by an Amazon fulfillment center.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $status_changed_date Indicates when the status last changed.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ReturnItemDisposition
     */
     ...
     *
     * @param \Swagger\Client\Model\ReturnItemDisposition $return_received_condition return_received_condition
     *
     * @return $this
     */
