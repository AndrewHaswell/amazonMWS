...
class FulfillmentOrder implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'displayable_order_date' => '\Swagger\Client\Model\Timestamp',
        'displayable_order_comment' => 'string',
        'shipping_speed_category' => '\Swagger\Client\Model\ShippingSpeedCategory',
        'delivery_window' => '\Swagger\Client\Model\DeliveryWindow',
        'destination_address' => '\Swagger\Client\Model\Address',
        'fulfillment_action' => '\Swagger\Client\Model\FulfillmentAction',
        'fulfillment_policy' => '\Swagger\Client\Model\FulfillmentPolicy',
        'cod_settings' => '\Swagger\Client\Model\CODSettings',
        'received_date' => '\Swagger\Client\Model\Timestamp',
        'fulfillment_order_status' => '\Swagger\Client\Model\FulfillmentOrderStatus',
        'status_updated_date' => '\Swagger\Client\Model\Timestamp',
        'notification_emails' => '\Swagger\Client\Model\NotificationEmailList',
        'feature_constraints' => '\Swagger\Client\Model\FeatureSettings[]'
    ];
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $displayable_order_date A date and time submitted with the createFulfillmentOrder operation. Displays as the order date in recipient-facing materials such as the packing slip.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ShippingSpeedCategory
     */
     ...
     *
     * @param \Swagger\Client\Model\ShippingSpeedCategory $shipping_speed_category shipping_speed_category
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\DeliveryWindow
     */
     ...
     *
     * @param \Swagger\Client\Model\DeliveryWindow $delivery_window delivery_window
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Address $destination_address The destination address submitted with the createFulfillmentOrder operation.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\FulfillmentAction
     */
     ...
     *
     * @param \Swagger\Client\Model\FulfillmentAction $fulfillment_action fulfillment_action
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\FulfillmentPolicy
     */
     ...
     *
     * @param \Swagger\Client\Model\FulfillmentPolicy $fulfillment_policy fulfillment_policy
     *
     * @return $this
     */
     ...
     * Gets cod_settings
     *
     * @return \Swagger\Client\Model\CODSettings
     */
     ...
     * Sets cod_settings
     *
     * @param \Swagger\Client\Model\CODSettings $cod_settings cod_settings
     *
     * @return $this
     */
     ...
     * Sets received_date
     *
     * @param \Swagger\Client\Model\Timestamp $received_date The date and time that the fulfillment order was received by an Amazon fulfillment center.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\FulfillmentOrderStatus
     */
     ...
     *
     * @param \Swagger\Client\Model\FulfillmentOrderStatus $fulfillment_order_status fulfillment_order_status
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $status_updated_date The date and time that the status of the fulfillment order last changed, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\NotificationEmailList
     */
     ...
     *
     * @param \Swagger\Client\Model\NotificationEmailList $notification_emails notification_emails
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\FeatureSettings[]
     */
     ...
     *
     * @param \Swagger\Client\Model\FeatureSettings[] $feature_constraints A list of features and their fulfillment policies to apply to the order.
     *
     * @return $this
     */
