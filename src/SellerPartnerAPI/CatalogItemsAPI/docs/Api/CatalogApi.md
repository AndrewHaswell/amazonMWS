...
# **getCatalogItem**
> \Swagger\Client\Model\GetCatalogItemResponse getCatalogItem($marketplace_id, $asin)
...
[**\Swagger\Client\Model\GetCatalogItemResponse**](../Model/GetCatalogItemResponse.md)
...
> \Swagger\Client\Model\ListCatalogCategoriesResponse listCatalogCategories($marketplace_id, $asin, $seller_sku)
...
[**\Swagger\Client\Model\ListCatalogCategoriesResponse**](../Model/ListCatalogCategoriesResponse.md)
...
# **listCatalogItems**
> \Swagger\Client\Model\ListCatalogItemsResponse listCatalogItems($marketplace_id, $query, $query_context_id, $seller_sku, $upc, $ean, $isbn, $jan)
...
[**\Swagger\Client\Model\ListCatalogItemsResponse**](../Model/ListCatalogItemsResponse.md)
