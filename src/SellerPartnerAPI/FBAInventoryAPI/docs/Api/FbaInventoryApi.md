...
> \Swagger\Client\Model\GetInventorySummariesResponse getInventorySummaries($granularity_type, $granularity_id, $marketplace_ids, $details, $start_date_time, $seller_skus, $next_token)
...
[**\Swagger\Client\Model\GetInventorySummariesResponse**](../Model/GetInventorySummariesResponse.md)
