...
class FeePreview implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'asin' => 'string',
        'price' => '\Swagger\Client\Model\MoneyType',
        'fee_breakdown' => '\Swagger\Client\Model\FeeLineItem[]',
        'total_fees' => '\Swagger\Client\Model\MoneyType',
     ...
     * Sets price
     *
     * @param \Swagger\Client\Model\MoneyType $price The price that the seller plans to charge for the item.
     *
     * @return $this
     */
     ...
     * Gets fee_breakdown
     *
     * @return \Swagger\Client\Model\FeeLineItem[]
     */
     ...
     * Sets fee_breakdown
     *
     * @param \Swagger\Client\Model\FeeLineItem[] $fee_breakdown A list of the Small and Light fees for the item.
     *
     * @return $this
     */
     ...
     * Sets total_fees
     *
     * @param \Swagger\Client\Model\MoneyType $total_fees The total fees charged if the item participated in the Small and Light program.
     *
     * @return $this
     */
     ...
     * Sets errors
     *
     * @param \Swagger\Client\Model\ErrorList $errors One or more unexpected errors occurred during the getSmallAndLightFeePreview operation.
     *
     * @return $this
     */
