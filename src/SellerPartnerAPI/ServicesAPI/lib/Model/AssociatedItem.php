...
class AssociatedItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'item_status' => 'string',
        'brand_name' => 'string',
        'item_delivery' => '\Swagger\Client\Model\ItemDelivery'
    ];
     ...
     * Sets order_id
     *
     * @param \Swagger\Client\Model\OrderId $order_id The Amazon-defined identifier for an order placed by the buyer, in 3-7-7 format.
     *
     * @return $this
     */
     ...
     * Gets item_delivery
     *
     * @return \Swagger\Client\Model\ItemDelivery
     */
     ...
     * Sets item_delivery
     *
     * @param \Swagger\Client\Model\ItemDelivery $item_delivery Delivery information for the item.
     *
     * @return $this
     */
