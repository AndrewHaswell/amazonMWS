...
class Promotion implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'promotion_id' => 'string',
        'promotion_amount' => '\Swagger\Client\Model\Currency'
    ];
     ...
     *
     * @param \Swagger\Client\Model\Currency $promotion_amount The amount of promotional discount applied to the item.
     *
     * @return $this
     */
