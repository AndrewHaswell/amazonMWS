...
class ShipmentEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order_charge_list' => '\Swagger\Client\Model\ChargeComponentList',
        'order_charge_adjustment_list' => '\Swagger\Client\Model\ChargeComponentList',
        'shipment_fee_list' => '\Swagger\Client\Model\FeeComponentList',
        'shipment_fee_adjustment_list' => '\Swagger\Client\Model\FeeComponentList',
        'order_fee_list' => '\Swagger\Client\Model\FeeComponentList',
        'order_fee_adjustment_list' => '\Swagger\Client\Model\FeeComponentList',
        'direct_payment_list' => '\Swagger\Client\Model\DirectPaymentList',
        'posted_date' => '\Swagger\Client\Model\\DateTime',
        'shipment_item_list' => '\Swagger\Client\Model\ShipmentItemList',
        'shipment_item_adjustment_list' => '\Swagger\Client\Model\ShipmentItemList'
    ];
     ...
     *
     * @return \Swagger\Client\Model\ChargeComponentList
     */
     ...
     *
     * @param \Swagger\Client\Model\ChargeComponentList $order_charge_list A list of order-level charges. These charges are applicable to Multi-Channel Fulfillment COD orders.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\ChargeComponentList $order_charge_adjustment_list A list of order-level charge adjustments. These adjustments are applicable to Multi-Channel Fulfillment COD orders.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\FeeComponentList
     */
     ...
     *
     * @param \Swagger\Client\Model\FeeComponentList $shipment_fee_list A list of shipment-level fees.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\FeeComponentList $shipment_fee_adjustment_list A list of shipment-level fee adjustments.
     *
     * @return $this
     */
     ...
     * Sets order_fee_list
     *
     * @param \Swagger\Client\Model\FeeComponentList $order_fee_list A list of order-level fees. These charges are applicable to Multi-Channel Fulfillment orders.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\FeeComponentList $order_fee_adjustment_list A list of order-level fee adjustments. These adjustments are applicable to Multi-Channel Fulfillment orders.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\DirectPaymentList
     */
     ...
     *
     * @param \Swagger\Client\Model\DirectPaymentList $direct_payment_list A list of transactions where buyers pay Amazon through one of the credit cards offered by Amazon or where buyers pay a seller directly through COD.
     *
     * @return $this
     */
     ...
     * Sets posted_date
     *
     * @param \Swagger\Client\Model\\DateTime $posted_date The date and time when the financial event was posted.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ShipmentItemList
     */
     ...
     *
     * @param \Swagger\Client\Model\ShipmentItemList $shipment_item_list shipment_item_list
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\ShipmentItemList $shipment_item_adjustment_list A list of shipment item adjustments.
     *
     * @return $this
     */
