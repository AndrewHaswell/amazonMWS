...
class PayWithAmazonEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'transaction_posted_date' => '\Swagger\Client\Model\\DateTime',
        'business_object_type' => 'string',
        'sales_channel' => 'string',
        'charge' => '\Swagger\Client\Model\ChargeComponent',
        'fee_list' => '\Swagger\Client\Model\FeeComponentList',
     ...
     *
     * @param \Swagger\Client\Model\\DateTime $transaction_posted_date The date and time when the payment transaction is posted. In ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     * Sets charge
     *
     * @param \Swagger\Client\Model\ChargeComponent $charge The charge associated with the event.
     *
     * @return $this
     */
     ...
     * Sets fee_list
     *
     * @param \Swagger\Client\Model\FeeComponentList $fee_list A list of fees associated with the event.
     *
     * @return $this
     */
