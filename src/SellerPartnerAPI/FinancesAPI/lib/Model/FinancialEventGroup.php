...
class FinancialEventGroup implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'original_total' => '\Swagger\Client\Model\Currency',
        'converted_total' => '\Swagger\Client\Model\Currency',
        'fund_transfer_date' => '\Swagger\Client\Model\\DateTime',
        'trace_id' => 'string',
        'account_tail' => 'string',
        'beginning_balance' => '\Swagger\Client\Model\Currency',
        'financial_event_group_start' => '\Swagger\Client\Model\\DateTime',
        'financial_event_group_end' => '\Swagger\Client\Model\\DateTime'
    ];
     ...
     * Sets original_total
     *
     * @param \Swagger\Client\Model\Currency $original_total The total amount in the currency of the marketplace in which the transactions occurred.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Currency $converted_total The total amount in the currency of the marketplace in which the funds were disbursed.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\\DateTime $fund_transfer_date The date and time when the disbursement or charge was initiated. Only present for closed settlements. In ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Currency $beginning_balance The balance at the beginning of the settlement period.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\\DateTime $financial_event_group_start The date and time at which the financial event group is opened. In ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\\DateTime $financial_event_group_end The date and time at which the financial event group is closed. In ISO 8601 date time format.
     *
     * @return $this
     */
