...
class ShipmentItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'item_charge_list' => '\Swagger\Client\Model\ChargeComponentList',
        'item_charge_adjustment_list' => '\Swagger\Client\Model\ChargeComponentList',
        'item_fee_list' => '\Swagger\Client\Model\FeeComponentList',
        'item_fee_adjustment_list' => '\Swagger\Client\Model\FeeComponentList',
        'item_tax_withheld_list' => '\Swagger\Client\Model\TaxWithheldComponentList',
        'promotion_list' => '\Swagger\Client\Model\PromotionList',
        'promotion_adjustment_list' => '\Swagger\Client\Model\PromotionList',
        'cost_of_points_granted' => '\Swagger\Client\Model\Currency',
        'cost_of_points_returned' => '\Swagger\Client\Model\Currency'
    ];
     ...
     *
     * @param \Swagger\Client\Model\ChargeComponentList $item_charge_list A list of charges associated with the shipment item.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\ChargeComponentList $item_charge_adjustment_list A list of charge adjustments associated with the shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
     ...
     * Sets item_fee_list
     *
     * @param \Swagger\Client\Model\FeeComponentList $item_fee_list A list of fees associated with the shipment item.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\FeeComponentList $item_fee_adjustment_list A list of fee adjustments associated with the shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\TaxWithheldComponentList
     */
     ...
     *
     * @param \Swagger\Client\Model\TaxWithheldComponentList $item_tax_withheld_list A list of taxes withheld information for a shipment item.
     *
     * @return $this
     */
     ...
     * Gets promotion_list
     *
     * @return \Swagger\Client\Model\PromotionList
     */
     ...
     * Sets promotion_list
     *
     * @param \Swagger\Client\Model\PromotionList $promotion_list promotion_list
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\PromotionList $promotion_adjustment_list A list of promotion adjustments associated with the shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Currency $cost_of_points_granted The cost of Amazon Points granted for a shipment item.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Currency $cost_of_points_returned The cost of Amazon Points returned for a shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
