...
class SolutionProviderCreditEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'transaction_amount' => '\Swagger\Client\Model\Currency',
        'transaction_creation_date' => '\Swagger\Client\Model\\DateTime'
    ];
     ...
     *
     * @param \Swagger\Client\Model\Currency $transaction_amount The amount of the credit.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\\DateTime $transaction_creation_date The date and time that the credit transaction was created, in ISO 8601 date time format.
     *
     * @return $this
     */
