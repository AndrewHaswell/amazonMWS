...
class DebtRecoveryItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'original_amount' => '\Swagger\Client\Model\Currency',
        'group_begin_date' => '\Swagger\Client\Model\\DateTime',
        'group_end_date' => '\Swagger\Client\Model\\DateTime'
    ];
     ...
     *
     * @param \Swagger\Client\Model\Currency $recovery_amount The amount applied for the recovery item.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Currency $original_amount The original debt amount.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\\DateTime $group_begin_date The beginning date and time of the financial event group that contains the debt. In ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     * Sets group_end_date
     *
     * @param \Swagger\Client\Model\\DateTime $group_end_date The ending date and time of the financial event group that contains the debt. In ISO 8601 date time format.
     *
     * @return $this
     */
