...
class ShipmentRequestDetails implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'amazon_order_id' => '\Swagger\Client\Model\AmazonOrderId',
        'seller_order_id' => '\Swagger\Client\Model\SellerOrderId',
        'item_list' => '\Swagger\Client\Model\ItemList',
        'ship_from_address' => '\Swagger\Client\Model\Address',
        'package_dimensions' => '\Swagger\Client\Model\PackageDimensions',
        'weight' => '\Swagger\Client\Model\Weight',
        'must_arrive_by_date' => '\Swagger\Client\Model\Timestamp',
        'ship_date' => '\Swagger\Client\Model\Timestamp',
        'shipping_service_options' => '\Swagger\Client\Model\ShippingServiceOptions',
        'label_customization' => '\Swagger\Client\Model\LabelCustomization'
    ];
     ...
     *
     * @return \Swagger\Client\Model\AmazonOrderId
     */
     ...
     *
     * @param \Swagger\Client\Model\AmazonOrderId $amazon_order_id An Amazon-defined order identifier in 3-7-7 format.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\SellerOrderId
     */
     ...
     *
     * @param \Swagger\Client\Model\SellerOrderId $seller_order_id A seller-defined order identifier.
     *
     * @return $this
     */
     ...
     * Gets item_list
     *
     * @return \Swagger\Client\Model\ItemList
     */
     ...
     * Sets item_list
     *
     * @param \Swagger\Client\Model\ItemList $item_list item_list
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Address $ship_from_address The address of the sender.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\PackageDimensions
     */
     ...
     *
     * @param \Swagger\Client\Model\PackageDimensions $package_dimensions The package dimensions.
     *
     * @return $this
     */
     ...
     * Sets weight
     *
     * @param \Swagger\Client\Model\Weight $weight The package weight.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Timestamp $must_arrive_by_date The date by which the package must arrive to keep the promise to the customer, in ISO 8601 datetime format. If MustArriveByDate is specified, only shipping service offers that can be delivered by that date are returned.
     *
     * @return $this
     */
     ...
     * Sets ship_date
     *
     * @param \Swagger\Client\Model\Timestamp $ship_date When used in a request, this is the date and time that the seller wants to ship the package. When used in a response, this is the date and time that the package can be shipped by the indicated method.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ShippingServiceOptions
     */
     ...
     *
     * @param \Swagger\Client\Model\ShippingServiceOptions $shipping_service_options Extra services offered by the carrier.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\LabelCustomization
     */
     ...
     *
     * @param \Swagger\Client\Model\LabelCustomization $label_customization Label customization options.
     *
     * @return $this
     */
