...
class OfferType implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'buying_price' => '\Swagger\Client\Model\PriceType',
        'regular_price' => '\Swagger\Client\Model\MoneyType',
     ...
     * Sets buying_price
     *
     * @param \Swagger\Client\Model\PriceType $buying_price Contains pricing information that includes promotions and contains the shipping cost.
     *
     * @return $this
     */
     ...
     * Sets regular_price
     *
     * @param \Swagger\Client\Model\MoneyType $regular_price The current price excluding any promotions that apply to the product. Excludes the shipping cost.
     *
     * @return $this
     */
