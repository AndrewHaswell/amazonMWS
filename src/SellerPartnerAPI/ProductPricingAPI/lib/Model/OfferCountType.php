...
class OfferCountType implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'condition' => 'string',
        'fulfillment_channel' => '\Swagger\Client\Model\FulfillmentChannelType',
        'offer_count' => 'int'
    ];
     ...
     *
     * @return \Swagger\Client\Model\FulfillmentChannelType
     */
     ...
     *
     * @param \Swagger\Client\Model\FulfillmentChannelType $fulfillment_channel Indicates whether the item is fulfilled by Amazon or by the seller.
     *
     * @return $this
     */
