...
> \Swagger\Client\Model\GetPricingResponse getCompetitivePricing($marketplace_id, $item_type, $asins, $skus)
...
[**\Swagger\Client\Model\GetPricingResponse**](../Model/GetPricingResponse.md)
...
# **getItemOffers**
> \Swagger\Client\Model\GetOffersResponse getItemOffers($marketplace_id, $item_condition, $asin)
...
[**\Swagger\Client\Model\GetOffersResponse**](../Model/GetOffersResponse.md)
...
# **getListingOffers**
> \Swagger\Client\Model\GetOffersResponse getListingOffers($marketplace_id, $item_condition, $seller_sku)
...
# **getPricing**
> \Swagger\Client\Model\GetPricingResponse getPricing($marketplace_id, $item_type, $asins, $skus, $item_condition)
