...
# **cancelReport**
> \Swagger\Client\Model\CancelReportResponse cancelReport($report_id)
...
[**\Swagger\Client\Model\CancelReportResponse**](../Model/CancelReportResponse.md)
...
> \Swagger\Client\Model\CancelReportScheduleResponse cancelReportSchedule($report_schedule_id)
...
[**\Swagger\Client\Model\CancelReportScheduleResponse**](../Model/CancelReportScheduleResponse.md)
...
# **createReport**
> \Swagger\Client\Model\CreateReportResponse createReport($body)
...
$body = new \Swagger\Client\Model\CreateReportSpecification(); // \Swagger\Client\Model\CreateReportSpecification | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\CreateReportSpecification**](../Model/CreateReportSpecification.md)|  |

### Return type

[**\Swagger\Client\Model\CreateReportResponse**](../Model/CreateReportResponse.md)
...
> \Swagger\Client\Model\CreateReportScheduleResponse createReportSchedule($body)
...
$body = new \Swagger\Client\Model\CreateReportScheduleSpecification(); // \Swagger\Client\Model\CreateReportScheduleSpecification | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\CreateReportScheduleSpecification**](../Model/CreateReportScheduleSpecification.md)|  |

### Return type

[**\Swagger\Client\Model\CreateReportScheduleResponse**](../Model/CreateReportScheduleResponse.md)
...
# **getReport**
> \Swagger\Client\Model\GetReportResponse getReport($report_id)
...
[**\Swagger\Client\Model\GetReportResponse**](../Model/GetReportResponse.md)
...
# **getReportDocument**
> \Swagger\Client\Model\GetReportDocumentResponse getReportDocument($report_document_id)
...
[**\Swagger\Client\Model\GetReportDocumentResponse**](../Model/GetReportDocumentResponse.md)
...
# **getReportSchedule**
> \Swagger\Client\Model\GetReportScheduleResponse getReportSchedule($report_schedule_id)
...
[**\Swagger\Client\Model\GetReportScheduleResponse**](../Model/GetReportScheduleResponse.md)
...
# **getReportSchedules**
> \Swagger\Client\Model\GetReportSchedulesResponse getReportSchedules($report_types)
...
[**\Swagger\Client\Model\GetReportSchedulesResponse**](../Model/GetReportSchedulesResponse.md)
...
# **getReports**
> \Swagger\Client\Model\GetReportsResponse getReports($report_types, $processing_statuses, $marketplace_ids, $page_size, $created_since, $created_until, $next_token)
...
[**\Swagger\Client\Model\GetReportsResponse**](../Model/GetReportsResponse.md)
