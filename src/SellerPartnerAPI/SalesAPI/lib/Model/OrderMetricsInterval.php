...
class OrderMetricsInterval implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order_count' => 'int',
        'average_unit_price' => '\Swagger\Client\Model\Money',
        'total_sales' => '\Swagger\Client\Model\Money'
    ];
     ...
     *
     * @param \Swagger\Client\Model\Money $average_unit_price The average price for an item based on the specified filters. Formula is totalSales/unitCount.
     *
     * @return $this
     */
     ...
     * Sets total_sales
     *
     * @param \Swagger\Client\Model\Money $total_sales The total ordered product sales for all orders based on the specified filters.
     *
     * @return $this
     */
