...
> \Swagger\Client\Model\GetMyFeesEstimateResponse getMyFeesEstimateForASIN($body, $asin)
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\GetMyFeesEstimateRequest**](../Model/GetMyFeesEstimateRequest.md)|  |
 **asin** | **string**| The Amazon Standard Identification Number (ASIN) of the item. |

### Return type

[**\Swagger\Client\Model\GetMyFeesEstimateResponse**](../Model/GetMyFeesEstimateResponse.md)
...
> \Swagger\Client\Model\GetMyFeesEstimateResponse getMyFeesEstimateForSKU($body, $seller_sku)
